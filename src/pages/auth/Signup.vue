    ...
    <div class="row login-page">
        ...
        <q-form ref="form" :greedy="true">
          ...
          >
            <q-avatar  size="100px" >
              <template #default>
                <q-img src="../../assets/logo-color.png" class="weight: "></q-img>
              </template>
            </q-avatar>
          </q-card-section>
          ...
          <q-card-section class="pt-0 pb-0 q-mb-lg">
            <p class="text-first text-dark mb-0 text-weight-bold">
                Have an account? <span  color="local-blue" class="text-first text-local-blue mb-0 text-weight-bold mt-0">
          ...
          <q-card-section class="px-20 pb-20 pt-5">
            <div class="row">
              ...
              <div class="row justify-between col-12 mt-20">
                <q-checkbox v-model="rememberme" label="I agree with terms and privacy policy" />
              </div>
      ...
      <div class="col-6 right_column" style="padding:200px 120px 0px 120px">  
        <p class="text-h3 text-light_white"> <span class="text-local-blue ">Products </span>FeedBack<br>
            </p>
